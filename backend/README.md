...
## Project Structure
    ...
    ├── withered_bonus_dev_108433  # Django project configurations
...
1. Clone this repo and `cd withered_bonus_dev_108433`
...
2. Clone this repo and `cd withered_bonus_dev_108433`
